// Redesign 2026-09 (follow-up, round 10) — country-calling-code list of
// values for the redesigned onboarding form's "Country code" select (Plot
// asked for "a LOV for all country code", defaulting to +91). No such list
// existed anywhere in the codebase before this — AuthScreen's phone field
// is a free-text placeholder ("+91 98480 00000") with no selector, and the
// old CustomerRegistrationForm's "Country code" was a plain free-text
// input. Sorted by country name; several countries share a dial code
// (e.g. +1 for the US/Canada, +44 for the UK/Guernsey/Jersey/Isle of Man) —
// that's expected, since only the dial code itself is stored.
